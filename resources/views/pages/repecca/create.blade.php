    ...
    <form action="{{ route('repecca.store') }}" method="POST">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="numero_historia_clinica" class="form-control" id="numero_historia_clinica">
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="sexo" class="form-label mb-0">Sexo <small class="requiredata">*</small></label>
                    ...
                    <div class="col-md-6 mb-2">
                        <label for="edad" class="form-label mb-0">Edad (años) <small class="requiredata">*</small></label>
                        <input type="number" name="edad" class="form-control" id="edad" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="estado_civil" class="form-label mb-0">Estado civil <small class="requiredata">*</small></label>
                    ...
                    <div class="col-md-6 mb-2">
                        <label for="grado_instruccion" class="form-label mb-0">Grado de instrucción <small class="requiredata">*</small></label>
                    ...
                    <div class="col-md-6 mb-2">
                        <label for="actividad_laboral" class="form-label mb-0">Actividad laboral <small class="requiredata">*</small></label>
                        <select name="actividad_laboral" id="actividad_laboral" class="form-control" required>
                            <option value="">Seleccionar...</option>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-2">
                        <label for="diagnostico_especifico" class="form-label mb-0">Diagnóstico específico y año de diagnóstico <small class="requiredata">*</small><span class="infotoltip" data-toggle="tooltip" data-placement="top" title="Colocar todos los diagnósticos de cardiopatías congénitas. Ejm: Coartación de aorta - 2014."></span></label>
                        <input type="text" name="diagnostico_especifico" class="form-control" id="diagnostico_especifico" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="transicion_cardiologia" class="form-label mb-0">Transición de cardiología pediátrica a adulto <small class="requiredata">*</small><span class="infotoltip" data-toggle="tooltip" data-placement="top" title="Considerar solo si fue referido del servicio de cardiología pediátrica a cardiología del adulto."></span></label>
                        <select name="transicion_cardiologia" id="transicion_cardiologia" class="form-control" required>
                    ...
                    <div class="col-md-12 mb-2">
                        <label for="sindrome_genetico_asociado1" class="form-label mb-0 d-block">Síndromes genéticos asociados <small class="requiredata">*</small></label>
                        <div class="form-control radioptions">
                    ...
                    <div class="col-md-6 mb-2">
                        <label for="severidad" class="form-label mb-0">Severidad de la cardiopatía congénita <small class="requiredata">*</small><span class="infotoltip" data-toggle="tooltip" data-placement="top" title="(Ver anexo 4)"></span></label>
                        <div class="form-control radioptions">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="severidad" id="severidad1" value="Simple" required>
                                <label class="form-check-label" for="severidad1">Simple</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="severidad" id="severidad2" value="Moderada" required>
                                <label class="form-check-label" for="severidad2">Moderada</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="severidad" id="severidad3" value="Severa" required>
                    ...
                    <div class="col-md-6 mb-2">
                        <label for="clase_funcional" class="form-label mb-0">Clase funcional (NYHA) <small class="requiredata">*</small></label>
                        <select name="clase_funcional" id="clase_funcional" class="form-control" required>
                            <option value="">Seleccionar...</option>
                    ...
                    <div class="col-md-6 mb-2">
                        <label for="dependencia_funcional" class="form-label mb-0">Dependencia funcional del paciente <small class="requiredata">*</small></label>
                        <select name="dependencia_funcional" id="dependencia_funcional" class="form-control" required>
                            <option value="">Seleccionar...</option>
                            <option value="Independiente">Independiente</option>
                    ...
                    <div class="col-md-6 mb-2">
                        <label for="hospitalizaciones" class="form-label mb-0">Hospitalizaciones por descompensación de la CC <small class="requiredata">*</small></label>
                        <div class="form-control radioptions">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="hospitalizaciones" id="hospitalizaciones1" value="No" required>
                                <label class="form-check-label" for="hospitalizaciones1">No</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="hospitalizaciones" id="hospitalizaciones2" value="Sí" required>
                                <label class="form-check-label" for="hospitalizaciones2">Sí</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="cianosis" class="form-label mb-0">Presenta actualmente cianosis <small class="requiredata">*</small></label>
                        <div class="form-control radioptions">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="cianosis" id="cianosis1" value="No" required>
                                <label class="form-check-label" for="cianosis1">No</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="cianosis" id="cianosis2" value="Sí" required>
                                <label class="form-check-label" for="cianosis2">Sí</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="saturacion_oxigeno" class="form-label mb-0">Saturación de oxigeno (última registrada en %) <small class="requiredata">*</small><span class="infotoltip" data-toggle="tooltip" data-placement="top" title="Solo colocar el número entre 0 a 100."></span></label>
                        <input type="number" name="saturacion_oxigeno" class="form-control" id="saturacion_oxigeno" max="100" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="peso" class="form-label mb-0">Peso actual del participante (Kg) <small class="requiredata">*</small></label>
                        <input type="number" name="peso" class="form-control" id="peso" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="talla" class="form-label mb-0">Talla actual del participante (m) <small class="requiredata">*</small></label>
                        <input type="number" name="talla" class="form-control" id="talla" required>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 mb-2">
                        <label for="manejo_recibido1" class="form-label mb-0 d-block">Manejo  recibido para la cardiopatía <small class="requiredata">*</small></label>
                        <div class="form-control radioptions">
                            <div class="form-check form-check-inline d-block">
                    ...
                    <div class="col-md-12 mb-2">
                        <label for="protesis_valvulares1" class="form-label mb-0 d-block">Colocación de prótesis valvulares <small class="requiredata">*</small></label>
                        <div class="form-control radioptions">
                            <div class="form-check form-check-inline d-block">
                    ...
                    <div class="col-md-6 mb-2">
                        <label for="procedimiento_electrofisiologico1" class="form-label mb-0 d-block">Procedimiento electrofisiológico <small class="requiredata">*</small></label>
                        <div class="form-control radioptions">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="procedimiento_electrofisiologico" id="procedimiento_electrofisiologico1" value="No" required>
                                <label class="form-check-label" for="procedimiento_electrofisiologico1">No</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="procedimiento_electrofisiologico" id="procedimiento_electrofisiologico2" value="Sí" required>
                                <label class="form-check-label" for="procedimiento_electrofisiologico2">Sí</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="marcapasos" class="form-label mb-0 d-block">Marcapasos <small class="requiredata">*</small></label>
                        <div class="form-control radioptions">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="marcapasos" id="marcapasos1" value="No" required>
                                <label class="form-check-label" for="marcapasos1">No</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="marcapasos" id="marcapasos2" value="Sí" required>
                                <label class="form-check-label" for="marcapasos2">Sí</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="aortoplastia" class="form-label mb-0 d-block">Aortoplastía <small class="requiredata">*</small></label>
                        <div class="form-control radioptions">
                            <div class="form-check form-check-inline">
                    ...
                    <div class="col-md-6 mb-2">
                        <label for="paciente" class="form-label mb-0 d-block">Stent en fístulas o tracto de salida del ventrículo derecho (TSVD) <small class="requiredata">*</small></label>
                        <div class="form-control radioptions">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="stent_fistulas" id="stent_fistulas1" value="No" required>
                                <label class="form-check-label" for="stent_fistulas1">No</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="stent_fistulas" id="stent_fistulas2" value="Sí" required>
                                <label class="form-check-label" for="stent_fistulas2">Sí</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="cirugia_cardiaca" class="form-label mb-0">Cirugía cardiaca y año de procedimiento <small class="requiredata">*</small><span class="infotoltip" data-toggle="tooltip" data-placement="top" title="Ejm: Fístula sistémico-pulmonar - 2010 / banding pulmonar  - 2010  / Cierre de defecto septal con parche  - 2010  / ligadura de PCA - 2010  / Corrección de TdF  - 2010  / Glenn  - 2010  / Fontan  - 2010  / Mustard o Senning  - 2010  / Jatene  - 2010  / Rastelli  - 2010  / otras - 2010  )"></span></label>
                        <input type="text" name="cirugia_cardiaca" class="form-control" id="cirugia_cardiaca" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="paciente" class="form-label mb-0 d-block">Ventrículo sistémico <small class="requiredata">*</small></label>
                        <div class="form-control radioptions">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="ventriculo_sistemico" id="ventriculo_sistemico1" value="Derecho" required>
                                <label class="form-check-label" for="ventriculo_sistemico1">Derecho</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="ventriculo_sistemico" id="ventriculo_sistemico2" value="Izquierdo" required>
                                <label class="form-check-label" for="ventriculo_sistemico2">Izquierdo</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="ventriculo_sistemico" id="ventriculo_sistemico3" value="Indeterminado" required>
                                <label class="form-check-label" for="ventriculo_sistemico3">Indeterminado</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="fraccion_eyeccion" class="form-label mb-0">Fracción de eyección del ventrículo izquierdo (FEVI, %) <small class="requiredata">*</small><span class="infotoltip" data-toggle="tooltip" data-placement="top" title="Considerar el último valor registrado de los últimos meses. Colocar solo el valor numérico entre 0 y 100 (Ejm: 60)."></span></label>
                        <input type="number" name="fraccion_eyeccion" class="form-control" id="fraccion_eyeccion" max="100" placeholder="Tu respuesta" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="funcion_sistolica1" class="form-label mb-0 d-block">Función sistólica del ventrículo derecho (VD) <small class="requiredata">*</small></label>
                        <div class="form-control radioptions">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="funcion_sistolica" id="funcion_sistolica1" value="Normal" required>
                                <label class="form-check-label" for="funcion_sistolica1">Normal</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="funcion_sistolica" id="funcion_sistolica2" value="Disminuida" required>
                                <label class="form-check-label" for="funcion_sistolica2">Disminuida</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="funcion_sistolica" id="funcion_sistolica3" value="Nunca medida" required>
                                <label class="form-check-label" for="funcion_sistolica3">Nunca medida</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 mb-2">
                        <label for="paciente" class="form-label mb-0">Tratamiento médico actual <small class="requiredata">*</small><span class="infotoltip" data-toggle="tooltip" data-placement="top" title="Puede marcar más de una respuesta"></span></label>
                        <div class="form-control radioptions">
                            <div class="form-check form-check-inline d-block">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 mb-2">
                        <label for="responsable" class="form-label mb-0">Arritmias <small class="requiredata">*</small><span class="infotoltip" data-toggle="tooltip" data-placement="top" title="Puede marcar más de una respuesta"></span></label>
                        <div class="form-control radioptions">
                            <div class="form-check form-check-inline d-block">
                    ...
                    <div class="col-md-12 mb-2">
                        <label for="paciente" class="form-label mb-0">Comorbilidades <small class="requiredata">*</small><span class="infotoltip" data-toggle="tooltip" data-placement="top" title="Puede marcar más de una respuesta"></span></label>
                        <div class="form-control radioptions">
                            <div class="form-check form-check-inline d-block">
                    ...
                    <div class="col-md-6 mb-2">
                        <label for="enfermedad_renal" class="form-label mb-0">Enfermedad renal crónica <small class="requiredata">*</small></label>
                        <select name="enfermedad_renal" id="enfermedad_renal" class="form-control" required>
                            <option value="No">No</option>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="complicaciones" class="form-control" id="complicaciones">
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="paciente" class="form-label mb-0">Uso de dispositivos de asistencia <small class="requiredata">*</small></label>
                        <select name="uso_dispositivos" id="uso_dispositivos" class="form-control" required>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-2">
                        <label for="creatinina_serica" class="form-label mb-0">Creatinina sérica (mg/dL) <small class="requiredata">*</small></label>
                        <input type="text" name="creatinina_serica" class="form-control" id="creatinina_serica" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="acido_urico_serico" class="form-label mb-0">Ácido úrico sérico(mg/dL) <small class="requiredata">*</small></label>
                        <input type="text" name="acido_urico_serico" class="form-control" id="acido_urico_serico" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="glucosa_serica" class="form-label mb-0">Glucosa sérica (mg/dL) <small class="requiredata">*</small></label>
                        <input type="text" name="glucosa_serica" class="form-control" id="glucosa_serica" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="colesterol_total" class="form-label mb-0">Coleterol total (mg/dL) <small class="requiredata">*</small></label>
                        <input type="text" name="colesterol_total" class="form-control" id="colesterol_total" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="colesterol_ldl" class="form-label mb-0">Colesterol LDL(mg/dL) <small class="requiredata">*</small></label>
                        <input type="text" name="colesterol_ldl" class="form-control" id="colesterol_ldl" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="trigliceridos" class="form-label mb-0">Triglicéridos (mg/dL) <small class="requiredata">*</small></label>
                        <input type="text" name="trigliceridos" class="form-control" id="trigliceridos" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="hemoglobina" class="form-label mb-0">Hemoglobina (g/dL) <small class="requiredata">*</small></label>
                        <input type="text" name="hemoglobina" class="form-control" id="hemoglobina" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="hematocrito" class="form-label mb-0">Hematocrito (%) <small class="requiredata">*</small></label>
                        <input type="text" name="hematocrito" class="form-control" id="hematocrito" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="plaquetas" class="form-label mb-0">Plaquetas (Número total contabilizado/uL) <small class="requiredata">*</small></label>
                        <input type="text" name="plaquetas" class="form-control" id="plaquetas" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="ferritina" class="form-label mb-0">Ferritina (mg/L) <small class="requiredata">*</small></label>
                        <input type="text" name="ferritina" class="form-control" id="ferritina" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="hierro_serico" class="form-label mb-0">Hierro sérico (ug/dL) <small class="requiredata">*</small></label>
                        <input type="text" name="hierro_serico" class="form-control" id="hierro_serico" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="saturacion_transferrina" class="form-label mb-0">Saturación de transferrina (%) <small class="requiredata">*</small></label>
                        <input type="text" name="saturacion_transferrina" class="form-control" id="saturacion_transferrina" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="tsh" class="form-label mb-0">Hormona estimulante de la tiroides (TSH) (mUI/L) <small class="requiredata">*</small></label>
                        <input type="text" name="tsh" class="form-control" id="tsh" required>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="t4_libre" class="form-label mb-0">Tiroxina libre (T4 libre) (ug/dL) <small class="requiredata">*</small></label>
                        <input type="text" name="t4_libre" class="form-control" id="t4_libre" required>
                    </div>
                </div>
            </div>
        </div>
