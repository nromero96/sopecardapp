                ...
                <div class="row">
                    ...
                    @else
                        ...
                        <div class="col-md-4 mb-2 mb-sm-0 text-right">
                            <a href="{{ route('renima.index') }}" class="btn btn-outline-primary mb-2 mb-sm-0">Regresar</a>
                        </div>
                    @endif
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const form = document.querySelector('#renimaForm'); // Asegúrate que tu form tenga este ID

        if (form) {
            form.querySelectorAll('input, select, textarea, button, radio, checkbox').forEach(element => {
